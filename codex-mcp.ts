  ...
  tools: [
    {
      ...
      description: [
        ...
        'In codex-backed rooms, the peer Codex should be treated as executor, verifier, or reviewer for the assigned slice; keep problem framing, design decisions, and final keep/revise/abort judgment in the caller Codex.',
        '',
